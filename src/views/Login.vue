  ...
  <div class="container">
    <div class="login">
      <div class="login__field">
        ...
        <input v-model="email" class="login__input" type="text" placeholder="Adresse mail" />
      </div>
      ...
      <div class="login__field">
        <input v-model="password" class="login__input" type="password" placeholder="Mot de passe" />
      </div>
      <div
        class="login__field"
